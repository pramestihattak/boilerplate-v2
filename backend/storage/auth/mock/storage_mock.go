...
// Source: ./backend/storage/auth/storage.go
//
// Generated by this command:
//
//	mockgen -source ./backend/storage/auth/storage.go -destination ./backend/storage/auth/mock/storage_mock.go
//
// Package mock_auth_storage is a generated GoMock package.
package mock_auth_storage
...
func (m *MockPostgresStore) Login(ctx context.Context, input *auth.LoginInput) (*auth.LoginOutput, error) {
	m.ctrl.T.Helper()
...
func (m *MockPostgresStore) Register(ctx context.Context, reg auth.Register) (string, error) {
	m.ctrl.T.Helper()
...
// Register mocks base method.
func (m *MockPostgresWriter) Register(ctx context.Context, reg auth.Register) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Register", ctx, reg)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
...
// Login mocks base method.
func (m *MockPostgresReader) Login(ctx context.Context, input *auth.LoginInput) (*auth.LoginOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Login", ctx, input)
	ret0, _ := ret[0].(*auth.LoginOutput)
	ret1, _ := ret[1].(error)
